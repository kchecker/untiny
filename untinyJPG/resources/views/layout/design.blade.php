...
<head>
  ...
  <!-- Favi- icon  -->
  <link rel="icon" href="{{ asset('images/favi-image/jpg-favi.png') }}" type="image/png" />

  <!-- Title  -->
  <title>untinyJPG – Instantly Upscale Your JPG Images 2X</title>

  <!-- Meta Description  -->
  <meta name="description" content="UntinyJPG lets you instantly upscale your JPG images by 2X while preserving quality and clarity. Fast, easy, and perfect for all your image enhancement needs." />

  <!-- Meta Keywords  -->
  <meta name="keywords" content="JPG upscaler, upscale JPG images, enlarge JPG, JPG image enhancer, 2x JPG upscale, increase JPG size, high-quality JPG enlargement, image upscaling tool, JPG resizer, untiny JPG" />

  <!-- Index Follow Meta Tag  -->
  <meta name="robots" content="index, follow" />

  <!-- Meta OG Tag -->
  <meta property="og:title" content="untinyJPG – Instantly Upscale Your JPG Images 2X" />
  <meta property="og:type" content="website" />
  <meta property="og:URL" content="https://www.untinyjpg.com/" />
  <meta property="og:image" content="https://www.untinyjpg.com/images/og-image/og-image.png" />
  <meta property="og:description" content="Instantly enlarge your JPG images by 2X with untinyJPG." />

  <!-- Canonical Script  -->
  <link rel="canonical" href="https://www.untinyjpg.com/" />

  <!-- Google tag (gtag.js) --> 
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-FNGFM0SVN9"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-FNGFM0SVN9'); </script>  
  ...
  <header class="bg-gray-800 container-shadow text-sky-400 py-4 shadow-md px-4">
    <div class="w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 sm:px-12">
      ...
      <div class="flex items-center mb-4 sm:mb-0 sm:ml-0 ml-4">
        <img src="{{ asset('images/logo-image/jpg-logo.png') }}" alt="Logo" class="w-10 h-10 mr-2" />
        <h1 class="text-2xl font-bold text-white whitespace-nowrap">untinyJPG.com</h1>
      </div>
      ...
      <div 
        ...
        <div 
          ...
          <p class="text-md mb-6 leading-6 text-slate-300">
            We’re building a powerful API to let you integrate untinyJPG’s image upscaling directly into your applications. Stay tuned for launch updates!
          </p>
          <button 
            onclick="hidePopup()" 
